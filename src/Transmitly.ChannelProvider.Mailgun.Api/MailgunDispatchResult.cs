...
{
	internal sealed class MailgunDispatchResult : IDispatchResult
	{
		public string? ResourceId { get; set; }

		public CommunicationsStatus Status { get; set; } = CommunicationsStatus.ClientError(MailgunConstant.Id, "Unknown");
